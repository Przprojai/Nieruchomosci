    ...
    public String onFlowProcess(FlowEvent event) {
        ...
        if (selected.getLogin().length() < 6) {
            ...
            return "personal";
                ...
                {if(selected.getIdMieszkania()==null) {FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Wybierz mieszkanie", "Wybierz mieszkanie")); return "mieszkanie"; }
